...
Функция СформироватьПечатнуюФорму(СсылкаНаДокумент, ОбъектыПечати) Экспорт
	...
	|	ПРЕДСТАВЛЕНИЕ(Документ.СтатьяРасходов) КАК СтатьяРасходов
	|ИЗ
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл
		...
		ОбластьПодписи.Параметры.Год = Формат(ВыборкаПоДокументам.Дата, "ДФ='yyyy ""г""'");
		ОбластьПодписи.Параметры.ПричинаСписания = ВыборкаПоДокументам.СтатьяРасходов;
